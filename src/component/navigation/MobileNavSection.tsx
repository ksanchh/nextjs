      ...
      <ul className="justify-content-center">
        <li className="tl-nav-item tl-dropdown">
          <a className={isDropdownOpen.home ? 'dropdown-open':''}>
            Home <span 
            className={`inner-mean-expand ${isDropdownOpen.home ? 'active':''}`}
            role='button' 
          ...
          <ul 
          className={`tl-submenu ${isDropdownOpen.home ? 'd-block':'d-none'}`}
          >
            <li>
        ...
        <li className="tl-nav-item tl-dropdown">
          ...
          Courses <span 
            className={`inner-mean-expand ${isDropdownOpen.courses ? 'active':''}`}
            role='button' 
            onClick={() => handleDropdownToggle('courses')}
            >{isDropdownOpen.courses ? '-':'+'}</span>
          </a>

          <ul 
          className={`tl-submenu ${isDropdownOpen.courses ? 'd-block':'d-none'}`}
          >
            <li>
        ...
        <li className="tl-nav-item tl-dropdown">
            ...
            Pages <span 
            className={`inner-mean-expand ${isDropdownOpen.page ? 'active':''}`}
            role='button' 
            onClick={() => handleDropdownToggle('page')}
            >{isDropdownOpen.page ? '-' : '+'}</span>
            </a>
          <ul 
          className={`tl-submenu ${isDropdownOpen.page ? 'd-block' : 'd-none'}`}
          >
            <li className="tl-dropdown-2">
                <a className={isDropdownOpen.about ? 'inner-dropdown-open':''}>
                About <span 
                className={`inner-mean-expand ${isDropdownOpen.about ? 'active':''}`}
                role='button' 
                onClick={() => handleDropdownToggle('about')}
                >{isDropdownOpen.about ? '-' : '+'}</span>
                </a>
              <ul 
              className={`tl-submenu tl-submenu-2 ${isDropdownOpen.about ? 'd-block' : 'd-none'}`}
              >
                <li>
            ...
            <li className="tl-dropdown-2">
                <a className={isDropdownOpen.staff ? 'inner-dropdown-open':''}>
                    Staff <span 
                    className={`inner-mean-expand ${isDropdownOpen.staff ? 'active':''}`}
                    role='button' 
                    onClick={() => handleDropdownToggle('staff')}
                    >{isDropdownOpen.staff ? '-' : '+'}</span>
                </a>

              <ul 
              className={`tl-submenu tl-submenu-2 ${isDropdownOpen.staff ? 'd-block' : 'd-none'}`}
              >
                <li>
            ...
            <li className="tl-dropdown-2">
              ...
              Event <span 
                    className={`inner-mean-expand ${isDropdownOpen.event ? 'active':''}`}
                    role='button' 
                    onClick={() => handleDropdownToggle('event')}
                    >{isDropdownOpen.event ? '-' : '+'}</span>
                </a>
              <ul 
              className={`tl-submenu tl-submenu-2 ${isDropdownOpen.event ? 'd-block' : 'd-none'}`}
              >
                <li>
            ...
            <li className="tl-dropdown-2">
                ...
                Authentication <span 
                className={`inner-mean-expand ${isDropdownOpen.auth ? 'active':''}`}
                role='button' 
                onClick={() => handleDropdownToggle('auth')}
                >{isDropdownOpen.auth ? '-' : '+'}</span>
                </a>
              <ul 
              className={`tl-submenu tl-submenu-2 ${isDropdownOpen.auth ? 'd-block' : 'd-none'}`}
              >
                <li>
        ...
        <a className={isDropdownOpen.blog ? 'dropdown-open':''}>
            Blogs <span 
            className={`inner-mean-expand ${isDropdownOpen.blog ? 'active':''}`}
            role='button' 
            onClick={() => handleDropdownToggle('blog')}
            >{isDropdownOpen.blog ? '-' : '+'}</span>
            </a>
          <ul 
          className={`tl-submenu ${isDropdownOpen.blog ? 'd-block' : 'd-none'}`}
          >
            <li className="tl-dropdown-2">
                <a className={isDropdownOpen.blogPages ? 'inner-dropdown-open':''}>
                Blog <span 
                className={`inner-mean-expand ${isDropdownOpen.blogPages ? 'active':''}`}
                role='button' 
                onClick={() => handleDropdownToggle('blogPages')}
                >{isDropdownOpen.blogPages ? '-' : '+'}</span>
                </a>

              <ul 
              className={`tl-submenu tl-submenu-2 ${isDropdownOpen.blogPages ? 'd-block' : 'd-none'}`}
              >
                <li>
        ...
        <li className="tl-nav-item tl-dropdown">
          ...
          Contact <span 
            className={`inner-mean-expand ${isDropdownOpen.contact ? 'active':''}`}
            role='button' 
            onClick={() => handleDropdownToggle('contact')}
            >{isDropdownOpen.contact ? '-' : '+'}</span>
            </a>
          <ul 
          className={`tl-submenu ${isDropdownOpen.contact ? 'd-block' : 'd-none'}`}
          >
            <li>
