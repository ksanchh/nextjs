...
const FooterSection5:React.FC<FooterProps> = ({style,lightLogo,darkLogo}) => {
                ...
                <div className="row gy-5 justify-content-between">
                    <div className="col-lg-3 col-sm-6 col-12">
                        <div className="tl-footer-widget tl-4-footer-widget">
                            ...
                            <p className="tl-4-footer-descr">Maurus herderite egret orca ac incident. Viramas at deque eu ipsum consenter commode egret t dam celestas beget mi.</p>
