...
const FooterSection7:React.FC<FooterProp> = ({logo}) => {
  return (
    <footer className="tl-footer tl-6-footer">
                        ...
                        <div className="row gy-5 justify-content-between">
                            <div className="col-md-5 col-sm-6 col-12">
                                <div className="tl-footer-widget">
                                    ...
                                    <p className="tl-5-footer-descr">Maurus herderite egret orca ac incident. Viramas at deque eu ipsum consenter commode egret t dam celestas beget mi.</p>

                                    <ul className="tl-3-footer-socials tl-6-footer-socials">
